...
# Use to copy all data from a Home Assistant LXC to a Podman Home Assistant LXC
# run from the Proxmox Shell
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/Mike-Allen/Proxmox/Localize/misc/copy-data/home-assistant-container-copy-data-podman-home-assistant.sh)"
