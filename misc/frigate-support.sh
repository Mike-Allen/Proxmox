...
while [ -z "${CTID:+x}" ]; do
  CTID=$(whiptail --backtitle "WDGIS Proxmox VE Helper Scripts" --title "Containers on $NODE" --radiolist \
...
# bash -c "$(wget -qLO - https://github.com/Mike-Allen/Proxmox/raw/Localize/misc/frigate-support.sh)"
