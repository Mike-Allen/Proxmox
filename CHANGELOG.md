...
- **AdventureLog LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/adventurelog-install.sh)
  - NEW Script
...
- **Wallos LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/wallos-install.sh)
  - NEW Script
- **Open WebUI LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/openwebui-install.sh)
  - NEW Script
...
- **Cockpit LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/cockpit-install.sh)
  - NEW Script
- **Neo4j LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/neo4j-install.sh)
  - NEW Script
...
- **ArchiveBox LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/archivebox-install.sh)
  - NEW Script
...
- **evcc LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/evcc-install.sh)
  - NEW Script
...
- **HomeBox LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/homebox-install.sh)
  - NEW Script
- **Zipline LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/zipline-install.sh)
  - NEW Script
...
- **Tianji LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/tianji-install.sh)
  - NEW Script
...
- **lldap LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/lldap-install.sh)
  - NEW Script
...
- **Gitea LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/gitea-install.sh)
  - NEW Script
...
- **Kubo LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/kubo-install.sh)
  - NEW Script
- **RabbitMQ LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/rabbitmq-install.sh)
  - NEW Script
- **Scrutiny LXC**
...
- **MySpeed LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/myspeed-install.sh)
  - NEW Script
...
- **PeaNUT LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/peanut-install.sh)
  - NEW Script
- **Website**
  - If the Changelog has changed recently, the link on the website will pulse.
- **Spoolman LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/spoolman-install.sh)
  - NEW Script
...
- **MeTube LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/metube-install.sh)
  - NEW Script
- **Matterbridge LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/matterbridge-install.sh)
  - NEW Script
- **Website**
...
- **Zabbix LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/zabbix-install.sh)
  - NEW Script
...
- **Petio LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/petio-install.sh)
  - NEW Script
- **Website**
...
- **FlareSolverr LXC** [(View Source)](https://github.com/Mike-Allen/Proxmox/blob/Localize/install/flaresolverr-install.sh)
  - NEW Script
...
- **[User Submitted Guides](https://github.com/Mike-Allen/Proxmox/blob/Localize/USER_SUBMITTED_GUIDES.md)**
...
- **Node-Red LXC**
  - Add Install [Themes Script](https://raw.githubusercontent.com/Mike-Allen/Proxmox/Localize/misc/images/node-red-themes.png)
...
- **Home Assistant Container LXC**
  - Add Options to [Update Menu](https://raw.githubusercontent.com/Mike-Allen/Proxmox/Localize/misc/images/update-menu.png)
...
- **Home Assistant Container LXC**
  - Add [Update Menu](https://raw.githubusercontent.com/Mike-Allen/Proxmox/Localize/misc/images/update-menu.png)
...
- **Mariadb LXC**
  - Add [Adminer](https://raw.githubusercontent.com/Mike-Allen/Proxmox/Localize/misc/images/adminer.png) (formerly phpMinAdmin), a full-featured database management tool
...
- **misc**
  - new GUI script [(Screenshot)](https://raw.githubusercontent.com/Mike-Allen/Proxmox/Localize/misc/images/pms-copy-data.png) to copy data from one Plex Media Server LXC to another Plex Media Server LXC 
